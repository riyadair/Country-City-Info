<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CityEntryWebForm.aspx.cs" Inherits="CountryCityWabApp.UI.CityEntryWebForm" %>
...
<body>
    <form id="form1" runat="server">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td class="auto-style1">
                            ...
                            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:CityInfoDBConnectionString %>" SelectCommand="SELECT [id], [name] FROM [tbl_Country]"></asp:SqlDataSource>
        ...
        <asp:GridView ID="showGridView" runat="server" AllowPaging="True">
        </asp:GridView>
